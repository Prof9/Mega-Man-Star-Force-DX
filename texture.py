...
mergeBmd(temp+'/models_overcharge1.nsbmd',				'imports/models_overcharge1.mdl.nsbmd',		'imports/texture_overcharge1.nsbtx')
mergeBmd(temp+'/models_overcharge1_cyan.nsbmd',			'imports/models_overcharge1.mdl.nsbmd',		'imports/texture_overcharge1_cyan.nsbtx')
mergeBmd(temp+'/models_overcharge1_gold.nsbmd',			'imports/models_overcharge1.mdl.nsbmd',		'imports/texture_overcharge1_gold.nsbtx')
mergeBmd(temp+'/models_overcharge2.nsbmd',				'imports/models_overcharge2.mdl.nsbmd',		'imports/texture_overcharge2.nsbtx')
