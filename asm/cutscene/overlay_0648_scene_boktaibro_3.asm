// Overlay 648 - Boktai brother 3 cutscene

.nds
.thumb
.create TEMP+"/overlay_0648.bin",0x21BE560
	...
	.dh	0x86	:: .dh	0x83		// Start NPC Brother registration
@@loop:
...
.align 4
overlay_0648_sinit_init:
	.dw	0
overlay_0648_sinit_init_end:
	.aligna	32
overlay_0648_size:
.close
...
.org 648 * 0x20
	.dw	648			// Overlay ID (overlay_0648)
	.dw	0x21BE560		// Load address
	.dw	overlay_0648_size	// Uncompressed size
	.dw	0			// BSS size
	.dw	overlay_0648_sinit_init
	.dw	overlay_0648_sinit_init_end
	.dw	648			// File ID
	.skip	4
