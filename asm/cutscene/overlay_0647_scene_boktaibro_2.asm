// Overlay 647 - Boktai brother 2 cutscene

.nds
.thumb
.create TEMP+"/overlay_0647.bin",0x21BE560
	...
	.dh	0x86	:: .dh	0x82		// Start NPC Brother registration
@@loop:
...
.align 4
overlay_0647_sinit_init:
	.dw	0
overlay_0647_sinit_init_end:
	.aligna	32
overlay_0647_size:
.close
...
.org 647 * 0x20
	.dw	647			// Overlay ID (overlay_0647)
	.dw	0x21BE560		// Load address
	.dw	overlay_0647_size	// Uncompressed size
	.dw	0			// BSS size
	.dw	overlay_0647_sinit_init
	.dw	overlay_0647_sinit_init_end
	.dw	647			// File ID
	.skip	4
