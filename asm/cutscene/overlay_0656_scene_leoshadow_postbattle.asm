// Overlay 656 - Leo Shadow post-battle cutscene

.nds
.thumb
.create TEMP+"/overlay_0656.bin",0x21BE560
...
@npc_01: // Leo Kingdom
	// Set sprite to Leo Shadow
	.dh	0x22	:: .dh	0x360			:: .align 4
	// Set position
...
.align 4
overlay_0656_sinit_init:
	.dw	0
overlay_0656_sinit_init_end:
	.aligna	32
overlay_0656_size:
.close
...
.org 656 * 0x20
	.dw	656			// Overlay ID (overlay_0656)
	.dw	0x21BE560		// Load address
	.dw	overlay_0656_size	// Uncompressed size
	.dw	0
	.dw	overlay_0656_sinit_init
	.dw	overlay_0656_sinit_init_end
	.dw	656			// File ID
	.skip	4
