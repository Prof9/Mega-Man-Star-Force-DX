// Overlay 577 - Pegasus Magic pre-battle cutscene

.nds
.thumb
.create TEMP+"/overlay_0577.bin",0x21BE560
.area 0x6A0
...
.align 4
overlay_0577_sinit_init:
	.dw	0
overlay_0577_sinit_init_end:
	.aligna	32
overlay_0577_size:
...
.org 577 * 0x20
	.dw	577			// Overlay ID (overlay_0577)
	.dw	0x21BE560		// Load address
	.dw	overlay_0577_size	// Uncompressed size
	.dw	0
	.dw	overlay_0577_sinit_init
	.dw	overlay_0577_sinit_init_end
	.dw	577			// File ID
	.skip	4
