// Overlay 650 - Boktai brother 5 cutscene

.nds
.thumb
.create TEMP+"/overlay_0650.bin",0x21BE560
	...
	.dh	0x86	:: .dh	0x85		// Start NPC Brother registration
@@loop:
...
.align 4
overlay_0650_sinit_init:
	.dw	0
overlay_0650_sinit_init_end:
	.aligna	32
overlay_0650_size:
.close
...
.org 650 * 0x20
	.dw	650			// Overlay ID (overlay_0650)
	.dw	0x21BE560		// Load address
	.dw	overlay_0650_size	// Uncompressed size
	.dw	0			// BSS size
	.dw	overlay_0650_sinit_init
	.dw	overlay_0650_sinit_init_end
	.dw	650			// File ID
	.skip	4
