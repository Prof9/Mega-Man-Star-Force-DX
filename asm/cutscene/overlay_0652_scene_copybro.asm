// Overlay 652 - Copy Brother cutscene

.nds
.thumb
.create TEMP+"/overlay_0652.bin",0x21BE560
	...
	.dh	0x86	:: .dh	0x80		// Start NPC Brother registration
@@loop:
...
.align 4
overlay_0652_sinit_init:
	.dw	0
overlay_0652_sinit_init_end:
	.aligna	32
overlay_0652_size:
.close
...
.org 652 * 0x20
	.dw	652			// Overlay ID (overlay_0652)
	.dw	0x21BE560		// Load address
	.dw	overlay_0652_size	// Uncompressed size
	.dw	0			// BSS size
	.dw	overlay_0652_sinit_init
	.dw	overlay_0652_sinit_init_end
	.dw	652			// File ID
	.skip	4
