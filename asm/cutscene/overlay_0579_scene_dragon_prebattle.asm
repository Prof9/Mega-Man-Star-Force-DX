// Overlay 579 - Dragon Sky pre-battle cutscene

.nds
.thumb
.create TEMP+"/overlay_0579.bin",0x21BE560
.area 0x6A0
...
.align 4
overlay_0579_sinit_init:
	.dw	0
overlay_0579_sinit_init_end:
	.aligna	32
overlay_0579_size:
...
.org 579 * 0x20
	.dw	579			// Overlay ID (overlay_0579)
	.dw	0x21BE560		// Load address
	.dw	overlay_0579_size	// Uncompressed size
	.dw	0
	.dw	overlay_0579_sinit_init
	.dw	overlay_0579_sinit_init_end
	.dw	579			// File ID
	.skip	4
