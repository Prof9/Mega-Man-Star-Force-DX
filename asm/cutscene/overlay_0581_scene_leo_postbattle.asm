// Overlay 581 - Leo Kingdom post-battle cutscene

.nds
.thumb
.create TEMP+"/overlay_0581.bin",0x21BE560
.area 0x6A0
...
.align 4
overlay_0581_sinit_init:
	.dw	0
overlay_0581_sinit_init_end:
	.aligna	32
overlay_0581_size:
...
.org 581 * 0x20
	.dw	581			// Overlay ID (overlay_0581)
	.dw	0x21BE560		// Load address
	.dw	overlay_0581_size	// Uncompressed size
	.dw	0
	.dw	overlay_0581_sinit_init
	.dw	overlay_0581_sinit_init_end
	.dw	581			// File ID
	.skip	4
