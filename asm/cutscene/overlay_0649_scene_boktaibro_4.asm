// Overlay 649 - Boktai brother 4 cutscene

.nds
.thumb
.create TEMP+"/overlay_0649.bin",0x21BE560
	...
	.dh	0x86	:: .dh	0x84		// Start NPC Brother registration
@@loop:
...
.align 4
overlay_0649_sinit_init:
	.dw	0
overlay_0649_sinit_init_end:
	.aligna	32
overlay_0649_size:
.close
...
.org 649 * 0x20
	.dw	649			// Overlay ID (overlay_0649)
	.dw	0x21BE560		// Load address
	.dw	overlay_0649_size	// Uncompressed size
	.dw	0			// BSS size
	.dw	overlay_0649_sinit_init
	.dw	overlay_0649_sinit_init_end
	.dw	649			// File ID
	.skip	4
