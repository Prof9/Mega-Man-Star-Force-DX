// Overlay 582 - Dragon Sky post-battle cutscene

.nds
.thumb
.create TEMP+"/overlay_0582.bin",0x21BE560
.area 0x6A0
...
@start:
	...
	// Load sprite Dragon Sky
	.dh	0x74	:: .db	0x01
			:: .db	0x05
			:: .dh	0x39C			:: .align 4, 0xFF
...
.align 4
overlay_0582_sinit_init:
	.dw	0
overlay_0582_sinit_init_end:
	.aligna	32
overlay_0582_size:
...
.org 582 * 0x20
	.dw	582			// Overlay ID (overlay_0582)
	.dw	0x21BE560		// Load address
	.dw	overlay_0582_size	// Uncompressed size
	.dw	0
	.dw	overlay_0582_sinit_init
	.dw	overlay_0582_sinit_init_end
	.dw	582			// File ID
	.skip	4
