...
.gba
.create TEMP+"/mrhertz-gold.spr.bin",0

	FileHeader

	TilesetHeader
	Tileset TEMP+"/mrhertz-gold-m0f0.img.bin",0	// 0
	Tileset TEMP+"/mrhertz-gold-m0f1.img.bin",0	// 1
	Tileset TEMP+"/mrhertz-gold-m0f2.img.bin",0	// 2
	Tileset TEMP+"/mrhertz-gold-m1f0.img.bin",0	// 3
	Tileset TEMP+"/mrhertz-gold-m1f1.img.bin",0	// 4
	Tileset TEMP+"/mrhertz-gold-m1f2.img.bin",0	// 5
	Tileset TEMP+"/mrhertz-gold-m2f0.img.bin",0	// 6
	Tileset TEMP+"/mrhertz-gold-m2f1.img.bin",0	// 7
	Tileset TEMP+"/mrhertz-gold-m2f2.img.bin",0	// 8

	PaletteHeader
	Palette	TEMP+"/mrhertz-gold.pal.bin"
