...
.gba
.create TEMP+"/omegaxis.spr.bin",0

	FileHeader

	TilesetHeader
	Tileset TEMP+"/omegaxis-m0f0.img.bin",0	// 0
	Tileset TEMP+"/omegaxis-m0f1.img.bin",0	// 1
	Tileset TEMP+"/omegaxis-m0f2.img.bin",0	// 2
	Tileset TEMP+"/omegaxis-m1f0.img.bin",0	// 3
	Tileset TEMP+"/omegaxis-m1f1.img.bin",0	// 4
	Tileset TEMP+"/omegaxis-m1f2.img.bin",0	// 5
	Tileset TEMP+"/omegaxis-m2f0.img.bin",0	// 6
	Tileset TEMP+"/omegaxis-m2f1.img.bin",0	// 7
	Tileset TEMP+"/omegaxis-m2f2.img.bin",0	// 8

	PaletteHeader
	Palette	TEMP+"/omegaxis.pal.bin"
	...
	Sprite	// 0: Mouth closed, fur 1
		...
		SpriteObject	 0,	-20,	-24,	SIZE_32x16,	FLIP_NONE,	0
		SpriteObject	 8,	 12,	-24,	SIZE_8x16,	FLIP_NONE,	0
		SpriteObject	10,	-20,	- 8,	SIZE_32x32,	FLIP_NONE,	0
		SpriteObject	26,	 12,	- 8,	SIZE_8x32,	FLIP_NONE,	1
